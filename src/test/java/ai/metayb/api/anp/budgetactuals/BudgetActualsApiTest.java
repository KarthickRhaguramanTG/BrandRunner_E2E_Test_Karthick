...
public class BudgetActualsApiTest extends BaseApiTest {
    ...
    @Test(groups = {"api", "smoke", "positive"}, description = "Get Budget Actuals returns the actuals status for a real budget")
    ...
    @Test(groups = {"api", "regression", "negative"}, description = "Get Budget Actuals without authentication fails")
    @Story("Get Budget Actuals")
